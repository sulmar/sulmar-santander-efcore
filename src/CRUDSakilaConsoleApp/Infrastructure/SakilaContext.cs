...
namespace CRUDSakilaConsoleApp.Infrastructure;
...
public partial class SakilaContext : DbContext
{
    ...
    public virtual DbSet<FilmsByRating> FilmsByRatings { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-RB5EAJ4\\SQLEXPRESS;Initial Catalog=sakila;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False;Application Name=SakilaConsoleApp")
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FilmsByRating>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("FilmsByRating");

            entity.Property(e => e.FilmCount).HasColumnName("film_count");
            entity.Property(e => e.Rating)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasColumnName("rating");
